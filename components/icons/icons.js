  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path
          strokeLinecap="round"
          d="M15 16.959h7m-13-10H2m0 10h2m18-10h-2"
        ></path>
      </g>
    </svg>
  );
...
export function Gender() {
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        <circle cx={14.5} cy={4.5} r={2.5}></circle>
        <path
          strokeLinecap="round"
          d="M19 21.996v-3.947c0-1.776-1.605-3.13-3.373-2.844m-7.679-1.77l-.025-.024c-1.042-1.007-.237-2.626.67-3.268c.907-.643 4.752-1.643 4.752 3.291C13.345 18.13 9.695 22 5 22"
        ></path>
      </g>
    </svg>
  );
