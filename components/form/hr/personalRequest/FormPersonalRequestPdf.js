      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.PersonalRequestCreateBy?.employeeEmployment?.[0]
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.PersonalRequestCreateBy?.employeeEmployment?.[0]
                ?.EmploymentDepartmentId?.departmentName || "-"}
            </Text>
            <Text style={styles.label}>
              มีความประสงค์ ขออัตรากำลังคนจำนวน :
            </Text>
            <Text style={styles.value}>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.PersonalRequestPositionId.positionName || "-"}
            </Text>

            <Text style={styles.label}>ประจำสาขา:</Text>
            <Text style={styles.value}>
              {item.PersonalRequestBranchId.branchName || "-"}
            </Text>

            <Text style={styles.label}>วันที่ต้องการ :</Text>
            <Text style={styles.value}>
              {item.personalRequestDesiredDate || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestEmploymentType || "-"}
            </Text>

            <Text style={styles.label}>เหตุผลในการขอรับ:</Text>
            <Text style={styles.value}>
              {item.personalRequestReasonForRequest || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestReasonGender || "-"}
            </Text>

            <Text style={styles.label}>2.อายุ:</Text>
            <Text style={styles.value}>
              {item.personalRequestReasonAge || "-"}
            </Text>

            <Text style={styles.label}>3.วุฒิการศึกษา:</Text>
            <Text style={styles.value}>
              {item.personalRequestReasonEducation || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestReasonEnglishSkill || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestReasonComputerSkill || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestReasonOtherSkill || "-"}
            </Text>
          </View>
          ...
          <View style={styles.textRow}>
            ...
            <Text style={styles.value}>
              {item.personalRequestReasonExperience || "-"}
            </Text>
          </View>

          <View style={styles.textRow}>
            <Text style={styles.label}>
              8.ลักษณะงาน และหน้าที่ความรับผิดชอบ ( แนบใบกำหนดลักษณะงาน Job
              Description FM-HR3-01 ):
            </Text>
          </View>
              ...
              <View style={styles.textRow}>
                ...
                <Image
                  ...
                  src={
                    item.PersonalRequestCreateBy?.employeeEmployment?.[0]
                      ?.employmentSignature
                      ? `/images/signature/${item.PersonalRequestCreateBy.employeeEmployment[0].employmentSignature}`
                      : "/images/signature/default_signature.png"
                  }
                />
