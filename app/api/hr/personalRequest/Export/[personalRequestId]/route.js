...
// จัดรูปแบบวันที่
    ...
    </head>    <body class="font-sans p-8">
      <div class="flex flex-col items-center justify-start w-full h-full p-2 gap-2 border-2">
        <div class="flex flex-row items-center justify-center w-full p-2 gap-2 border-2">
          <div class="flex items-center justify-center h-full p-2 gap-2 border-2">
            <img src="${process.env.NEXT_PUBLIC_API_URL}/images/company_logo/company_logo.png" class="w-28 min-h-28" />
          </div>
          <div class="flex items-center justify-start w-full h-full p-2 gap-2 border-2 text-3xl font-[900]">
            ใบขออัตรากำลังคน : Personnel Request
          </div>
        </div>

        <div class="flex flex-row items-center justify-center w-full p-2 gap-2 border-2">
          <div class="flex flex-row items-center justify-center w-full h-full p-2 gap-2 border-2">
            <div class="flex items-center justify-start w-full h-full p-2 gap-2 border-2">
        ...
        <div class="flex flex-row items-center justify-center w-full p-2 gap-2 border-2">
          <div class="flex flex-row items-center justify-center w-full h-full p-2 gap-2 border-2">
            ...
            <div class="flex flex-col items-center justify-center w-full h-full p-2 gap-2">
              <label class="flex items-center justify-start w-full h-full p-2 gap-2 border-2">
                <input
                  type="checkbox"
        ...
        <div class="flex flex-row items-center justify-center w-full p-2 gap-2 border-2">
          <div class="flex flex-col items-center justify-center w-full h-full p-2 gap-2 border-2">
            <div class="flex flex-row items-center justify-center w-full h-full p-2 gap-2 border-2">
              <div class="flex items-center justify-center w-full h-full p-2 gap-2 border-2">
                ลงชื่อ
              </div>
              <div class="flex items-center justify-center w-full h-full p-2 gap-2 border-b-2">
