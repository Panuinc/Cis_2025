...
export async function GET(request, context) {
  ...
  try {
    ...
    <body class="font-sans p-4">
      <div class="flex flex-col items-center justify-start w-full h-full p-2 border-2 border-dashed">
        <div class="flex flex-row items-center justify-center w-full p-2 border-2 border-danger border-dashed">
          <div class="flex items-center justify-center h-full p-2 border-2 border-dashed">
            <img src="${process.env.NEXT_PUBLIC_API_URL}/images/company_logo/company_logo.png" class="w-28 min-h-28" />
          </div>
          <div class="flex items-center justify-start w-full h-full p-2 border-2 border-dashed text-3xl font-[900]">
            ใบขออัตรากำลังคน : Personnel Request
          </div>
        </div>

        <div class="flex flex-row items-center justify-center w-full p-2 border-2 border-danger border-dashed">
          <div class="flex flex-row items-center justify-center w-full h-full p-2 border-2 border-dashed">
            <div class="flex items-center justify-start w-full h-full p-2 border-2 border-dashed">
              ด้วยข้าพเจ้า นาย / นาง / นางสาว
            </div>
            <div class="flex items-center justify-center w-full h-full p-2 border-b-2">
        ...
        <div class="flex flex-row items-center justify-center w-full p-2 border-2 border-danger border-dashed">
          <div class="flex flex-row items-center justify-center w-full h-full p-2 border-2 border-dashed">
            ...
            <div class="flex items-center justify-start w-full h-full p-2 border-b-2">
        ...
        <div class="flex flex-row items-center justify-center w-full p-2 border-2 border-danger border-dashed">
          <div class="flex flex-col items-center justify-center w-full h-full p-2 border-2 border-dashed">
            <div class="flex flex-row items-center justify-center w-full h-full p-2 border-2 border-dashed">
              <div class="flex items-center justify-center w-full h-full p-2 border-2 border-dashed">
                ลงชื่อ
              </div>
              <div class="flex items-center justify-center w-full h-full p-2 border-b-2">
            ...
            <div class="flex flex-row items-center justify-center w-full h-full p-2 border-2 border-dashed">
              <div class="flex items-center justify-end w-full h-full p-2 border-2 border-dashed">
                วันที่
              </div>
              <div class="flex items-center justify-start w-full h-full p-2 border-b-2">
                ${formattedCreateAt}
