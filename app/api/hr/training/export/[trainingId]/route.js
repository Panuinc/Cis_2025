...
export async function GET(request, context) {
  ...
  try {
    ...
    const date = new Date(training.trainingStartDate);
    ...
    const formattedStartDate = `${year}-${month}-${day} ${hours}:${minutes}`;
    const formattedEndDate = `${year}-${month}-${day} ${hours}:${minutes}`;
