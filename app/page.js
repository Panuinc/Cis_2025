    ...
    return (
      <>
        ...
        <form
          ...
          className="flex flex-col items-center justify-center w-full min-h-[500px] xl:w-4/12 p-2 gap-2 border-2 border-dark border-dashed bg-white rounded-3xl shadow-sm"
        >
